...
<head>
  ...
  <link rel="stylesheet" href="/graficas/Amanda/css/morris.css">
    <script src = "OfflineGPS\OfflineMaps.js"></script>
  <!-- External JS code -->
    ...
    <div class="row center-row no-gutter" height="500px">
      <div class="col-md-6">
        <!-- <div id="map" style = "visibility: hidden"> -->
          <img id = "parent" src = "img\Map.PNG" style = "width: 600px; height: 400px" />
          <img id = "element" src = "img\moonbuggy.png" style= "width: 25px; height: 25px"/>
        <!-- </div> -->
...
*/
      ...
      <div class="col-md-6 col-sm-6 fluid" style="align-items: center">
        <!--camera-->
        ...
        -->
        <img src="http://192.168.0.15:8081/" style="width:400px;height:400px; align-items: center">
        <!--
        Camera
        <p><img src="graficas/Amanda/images/camara.jpg" width="250"></p>
      -->
...
$(document).ready(function(){
  var map = new OfflineMaps(600,400, 25,25);
    ...
    if(dbOnOff == true){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          graph3.setData(data);
          graph4.setData(data);
          map.refresh(data[0].VDI, data[0].VDS);//doesnt rly ok
          console.log("data: "+data[0]['VDI']+", "+ data[0]['VDS'])
        }
      });
    }}, 3000);
  });
