...
$sqi = "INSERT INTO buggy2 (temperatura, vibracionDI, vibracionDS,vibracionIS)
      ...
      function callPos(){
       ...
       function initMap() {
         var map = new google.maps.Map(document.getElementById('map'), {
           center: callPos();//{lat: -34.397, lng: 150.644},
           zoom: 18,
           mapTypeId: 'satellite'
         });
 ...
 <script>
     ...
     $(document).ready(function(){
       setInterval(function(){
         var form_data = <?php json_encode($chart_data);?>;
         $.ajax({
          url:"ForReport.php",
          method:"POST",
          data:form_data,
